...
class FizzTest  extends FlatSpec with Matchers {
  ...
  it should "return fizz buzz" in { //number is not div by 5, not div by 3 but has a 3 and a 5 in it
    FizzBuzz.fizzBuzz2(53) shouldBe "fizz buzz"
  }

  it should "return fizz buzz" in {   //number is div by 5, not div by 3 but has a 3 in it
    FizzBuzz.fizzBuzz2(35) shouldBe "fizz buzz"
  }

  it should "return fizz buzz" in {   //number is div by 3, not div by 5 and has a 5 in it
